...
/**
 * 4.5 В классе демонстрируется использование аннотации {@link Owner}.
 */
public class DemoAnnotationOwner {
    ...
    @Owner("Чак Норрис")
    @Test(description = "Демонстрация использования аннотации @Owner")
